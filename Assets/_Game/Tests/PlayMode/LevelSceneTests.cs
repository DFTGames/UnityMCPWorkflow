...
{
    /// <summary>
    /// Integration tests for the level scene, playing Level 1's data: real physics, prefabs and the GameRunner wiring.
    ...
    /// </summary>
    public class LevelSceneTests : LevelSceneFixture
    {
