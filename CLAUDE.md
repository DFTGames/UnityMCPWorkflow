...
**Check the console for compile errors before trusting a run**: when a test assembly fails to compile, the run silently uses the last good assembly and reports the old results as passing.
